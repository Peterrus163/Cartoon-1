...
void house (int x, int y, double size);
void man   (int x, int y, double size);
void girl  (int x, int y, double size);
void tree  (int x, int y, double size);
void sun   (int x, int y, double size);
...
void man   (int x, int y, double size)
    ...
    txLine     (x - 100*size, y + 50*size, x -  50*size, y*size);
    txLine     (x +  50*size, y*size,      x + 100*size, y + 50*size);
...
void girl  (int x, int y, double size)
    {
    txSetColor (RGB (  0,   0,   0), 3);
    txLine     (x - 75*size, y + 45*size, x*size,      y + 20*size);
    txLine     (x*size,      y + 20*size, x + 75*size, y + 45*size);
